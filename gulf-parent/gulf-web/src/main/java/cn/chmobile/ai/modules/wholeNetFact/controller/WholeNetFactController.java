package cn.chmobile.ai.modules.wholeNetFact.controller;
 ...
 */
@Controller
@RequestMapping(value =  "/home/wholeNetFact")
public class WholeNetFactController extends BaseController {
	@Autowired
	private ITdBaseService tdBaseService;
	
    @RequestMapping(value="/showScalePie.json",method=RequestMethod.GET)
    @ResponseBody
    public Object getEciList(HttpServletRequest request,Model model) throws Exception{
        ...
        List<PageData> list = this.tdBaseService.findListByParam("rpt_d_city_dist_eci_sum", pd);
