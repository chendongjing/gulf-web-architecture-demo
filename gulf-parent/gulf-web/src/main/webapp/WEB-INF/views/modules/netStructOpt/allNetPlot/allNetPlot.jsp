...
<html lang="en">
			...
			<div class="widget-body  no-padding">
				<div class="widget-toolbox" id="widget-toolbox-1">
					...
					<span class="input-icon">
					    <select id="coverType" name="coverType" class="form-control" placeholder="请选择覆盖类型" style="width: 137px !important;border-radius:4px;height:28px;padding-top: 0px;margin-bottom: -9px;" >
	...
	<myscript>				
		...
		<script type="text/javascript" src="<%= request.getContextPath() %>/static/scripts/modules/js/allNetPlot.js"></script>
		<script type="text/javascript">
			jQuery(function($) {
				...
				$("#btn-point").on("click",function(e){
					...
					coverType = $("#coverType").find("option:selected").val();
					if (city_code == '') {
						layer.alert("请选择地市!");
						return false;
					}
					...
					var keyRow = cdate +coverType+ city_code + area_code;  
