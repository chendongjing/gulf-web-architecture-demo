...
<html lang="en">
	...
	<myscript>				
		...
		<script type="text/javascript" src="<%= request.getContextPath() %>/static/scripts/modules/js/weakCoverageDist.js"></script>
		<script type="text/javascript">
			jQuery(function($) {
				...
				$("#btn-point").on("click",function(e){
					...
					var keyRow = cdate +"2"+ city_code + area_code;  //2表示是弱覆盖
