...
<html lang="en">
	...
	<myscript>				
		...
		<script type="text/javascript" src="<%= request.getContextPath() %>/static/scripts/modules/js/emptyCoverageDist.js"></script>
		<script type="text/javascript">
			jQuery(function($) {
				...
				$("#btn-point").on("click",function(e){
					...
					var keyRow = cdate +"1"+ city_code + area_code;  //1表示是空洞覆盖
