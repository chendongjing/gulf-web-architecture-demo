...
<script type="text/javascript" src="<%= request.getContextPath() %>/static/scripts/modules/js/problemDistList.js"></script>
<!-- dataTables -->
<script
...
jQuery(function($) {
	...
	$("#getAllEciList").on("click",function(e){
		...
		var startRow = cdate + city_code + area_code;
		var datatableUrl = projectName+"/home/ProblemDist/getEciList.json?startRow="+startRow;
